...
rule deltares_coastal_average_annual_risk_protected:
    """
    This rule calculates one layer (average annual relative risk) given a set of 
    Deltares coastal return period flood maps. 
    """
    ...
    wildcard_constraints:
        VULN_CURVE="BER|JRC|EXP|NRES|INFR",
    script:
        "./deltares-coastal_average_annual_risk_protected.py"
"""
Test with
snakemake -c1 data/results/flood_risk/countries/KEN/KEN_deltares-coastal-flood-risk_protected_AAR_V-JRC.tif
"""
